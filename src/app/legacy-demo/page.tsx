...
type ApiJob = {
  ...
  tags?: string[] | null;
  // Belangrijk: Supabase-relatie kan een array opleveren
  sponsors?: ApiSponsor[] | null;
};
...
export default async function Page() {
  ...
  // Haal een kleine demo-set op (geen club-filter, puur ter voorbeeld)
  ...
  if (error) {
    throw new Error(`Fout bij ophalen demo-jobs: ${error.message}`);
  }
