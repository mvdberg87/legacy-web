  ...
  return (
    <main className="max-w-4xl mx-auto px-6 py-24">
      ...
      <ul className="mt-4 list-disc ml-6 space-y-2">
        <li>Naam en e-mailadres van gebruikers</li>
        <li>Accountgegevens van clubs en sponsors</li>
        <li>Bedrijfsgegevens die nodig zijn voor het plaatsen van vacatures</li>
        <li>Vacaturegegevens zoals functietitel en bedrijfsnaam</li>
      ...
      <h2 className="mt-10 text-xl font-semibold">Betalingen</h2>
      ...
      <p className="mt-4">
        ...
        interacties met functies van het platform.
      </p>
...
<p className="mt-4">
  Voorbeelden hiervan zijn hosting- en infrastructuurdiensten,
  analyse- en statistiekdiensten en betalingsverwerkers voor abonnementen.
</p>
...
<p className="mt-4">
  ...
  van persoonsgegevens te waarborgen.
      ...
      <h2 className="mt-10 text-xl font-semibold">Rechten van gebruikers</h2>

      <p className="mt-4">
        Je hebt het recht om jouw persoonsgegevens in te zien, te corrigeren of
        te laten verwijderen. Daarnaast kun je bezwaar maken tegen de
        verwerking van jouw gegevens. Voor verzoeken kun je contact opnemen via
        het onderstaande e-mailadres.
      </p>

      <h2 className="mt-10 text-xl font-semibold">Klachten</h2>
